...
The SIR model is a classical compartmental model in epidemiology [@kermack1927contribution; @keeling2008modeling]. It is also a good first reminder that the `solve_ivp` workflow from Session 1 applies to small systems just as naturally as to scalar equations.
