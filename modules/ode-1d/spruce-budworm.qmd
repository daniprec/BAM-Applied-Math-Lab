...
from amlab.odes_1d.spruce_budworm import plot_spruce_budworm_rate
...
from amlab.odes_1d.spruce_budworm import evolve_spruce_budworm, plot_spruce_budworm
...
$$ {#eq-ode-1d-spruce-budworm-2}

This can be rewritten as:

$$
rx^*\left(1 - \frac{x^*}{k}\right) = \frac{(x^*)^2}{1 + (x^*)^2}
$$ {#eq-ode-1d-spruce-budworm-3}
