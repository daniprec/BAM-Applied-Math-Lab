...
This assignment turns the 1D ODE workflow into a complete mini-project. The spruce budworm model combines a scalar ODE, equilibrium structure, numerical integration, and an interactive front end [@strogatz2024nonlinear].
