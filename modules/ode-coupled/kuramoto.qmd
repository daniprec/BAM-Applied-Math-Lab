...
from sessions.s05_odes_coupled.kuramoto import initialize_oscillators, kuramoto_order_parameter
...
If you get stuck, see the mini template in [sessions/s05_odes_coupled/kuramoto_template_mini.py](../../sessions/s05_odes_coupled/kuramoto_template_mini.py).
