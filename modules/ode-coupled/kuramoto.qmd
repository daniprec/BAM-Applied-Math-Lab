...
from code.odes_coupled.kuramoto import initialize_oscillators, kuramoto_order_parameter
...
If you get stuck, see the mini template in [code/odes_coupled/kuramoto_template_mini.py](../../code/odes_coupled/kuramoto_template_mini.py).
