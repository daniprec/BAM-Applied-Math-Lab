...
Start from the template in [sessions/s05_odes_coupled/kuramoto_template.py](../../sessions/s05_odes_coupled/kuramoto_template.py) and implement the missing parts.
