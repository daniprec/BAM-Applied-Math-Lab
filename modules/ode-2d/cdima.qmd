...
where $x$ and $y$ represent concentrations of chemical species, and $a,b$ are parameters controlling the reaction rates [@scott1994nonlinear, Chapter 8.3].
...
Where $f$ and $g$ are the right-hand sides of the ODEs for $\dot x$ and $\dot y$, respectively. For the CDIMA system:

$$J =
\begin{bmatrix}
-1 - \frac{4y}{1+x^2} + \frac{8x^2y}{(1+x^2)^2} & -\frac{4x}{1+x^2} \\
b \left( 1 - \frac{y}{1+x^2} \right) & -\frac{bx}{1+x^2}
\end{bmatrix}$$
...
- [@strogatz2024nonlinear, chap. 8.3] for theoretical background on the CDIMA model and phase-plane analysis.
