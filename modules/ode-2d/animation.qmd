...
If you struggle with this part, feel free to check a complete example of the [CDMI animation here](https://github.com/daniprec/BAM-Applied-Math-Lab/blob/main/code/odes_2d/cdima.py).
