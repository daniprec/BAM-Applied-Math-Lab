...
[Go to this example](cdima.qmd){.btn .btn-primary}
...
[Go to this example](van-der-pol.qmd){.btn .btn-primary}
...
[Go to this example](fitzhugh-nagumo.qmd){.btn .btn-primary}
...
Go to the [assignment page](./assignment.qmd) for the details of the coding task, and check out the provided code for each model to get a head start.

The [CDIMA model](./cdima.qmd) is fully explained and implemented, so it's a great place to start. Then, you can move on to the Van der Pol and FitzHugh–Nagumo models.