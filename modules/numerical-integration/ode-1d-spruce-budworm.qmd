...
Figure @fig-graph shows an example of the expected output.

![Example phase portrait of the spruce budworm model showing stable (blue) and unstable (red) equilibria. The green dashed line indicates the current population $x_t$. Where do you think this population will evolve?](../../img/s01_spruce_budworm.png){#fig-graph width=80%}
...
See Figure @fig-time-series for an example output.

![Example time series of the spruce budworm population over time.](../../img/s01_spruce_budworm_evolution.png){#fig-time-series width=80%}
...
Implement the complete Streamlit application as described above, following sections @sec-implementing-ode-function through @sec-streamlit-application. Ensure that all functions are correctly defined and integrated into the app. Test the application thoroughly to confirm that it behaves as expected.

Answer at least three of the exploration questions from section @sec-exploration-questions and document your findings in a brief report (1-2 pages). You are encouraged to use LaTeX here. Include screenshots of your application demonstrating different behaviors observed during your exploration.
...
- Implement some of the advanced features mentioned in section @sec-streamlit-application.
