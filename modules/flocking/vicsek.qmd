...
from sessions.s06_flocking.vicsek import initialize_particles
...
If you want to use a template, start from [sessions/s06_flocking/vicsek_template.py](../../sessions/s06_flocking/vicsek_template.py).
