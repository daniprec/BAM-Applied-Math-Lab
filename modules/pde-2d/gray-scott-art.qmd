...
This page adds interaction to the Gray-Scott simulation: draw sources of $v$, pause/resume, and adjust parameters with sliders. The reference implementation is in [code/pdes_2d/gray_scott.py](../../code/pdes_2d/gray_scott.py).
