...
This page adds interaction to the Gray-Scott simulation: draw sources of $v$, pause/resume, and adjust parameters with sliders [@gray1984autocatalytic; @pearson1993complex]. The reference implementation is in [amlab/pdes_2d/gray_scott.py](../../amlab/pdes_2d/gray_scott.py).
