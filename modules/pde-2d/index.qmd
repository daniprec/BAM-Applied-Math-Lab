...
This session builds directly on the 1D PDE workflow. We move from a line to a rectangular grid, keep the same finite-difference and explicit Euler ideas, and then switch to the Gray-Scott model for richer two-dimensional pattern formation [@gray1984autocatalytic; @pearson1993complex].
...
Then we switch reaction terms and build the **Gray-Scott model**, which is the main simulator for this session.
...
3. Build the Gray-Scott model and experiment with feed and kill rates.
