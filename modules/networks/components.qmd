...
In the next page, we will learn how to analyze the structure of a graph by looking at its components, such as connected components and the giant component. We will also see how to compute basic properties of a graph, such as degree and path length.

[Network Properties](properties.qmd){.btn .btn-primary}
