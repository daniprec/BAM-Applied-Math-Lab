...
The SIS (Susceptible–Infected–Susceptible) model is a simple epidemic model where individuals can be infected multiple times [@keeling2008modeling; @pastor2015epidemic]. In this module, we implement SIS on networks using NetworkX and explore how **network structure** (random vs small-world vs scale-free) changes spreading.
...
A susceptible node with $m$ infected neighbors becomes infected with probability [@keeling2008modeling]:
