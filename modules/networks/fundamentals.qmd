...
A graph is a mathematical structure used to model pairwise relations between objects. It consists of **nodes** (also called vertices) and **edges** (also called links) that connect pairs of nodes [@newman2018networks].

In this page, we will explore the basic elements of a graph using the `networkx` library in Python [@hagberg2008networkx]. We will cover:
