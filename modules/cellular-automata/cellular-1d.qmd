...
from code.cellular_automata.cellular import apply_rule
...
The script [code/cellular_automata/cellular.py](../../code/cellular_automata/cellular.py) lets you click on the first row to toggle cells and recompute the automaton.
