...
from sessions.s10_cellular_automata.cellular import apply_rule
...
The script [sessions/s10_cellular_automata/cellular.py](../../sessions/s10_cellular_automata/cellular.py) lets you click on the first row to toggle cells and recompute the automaton.
