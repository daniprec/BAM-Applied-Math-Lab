...
In the previous session on PDEs, you updated each grid point with a local stencil and explicit time stepping.
...
[Back to PDEs](../pde/index.qmd){.btn .btn-secondary}
