...
from amlab.flocking.vicsek import initialize_particles
...
If you want to use a template, start from [amlab/flocking/vicsek_template.py](../../amlab/flocking/vicsek_template.py).
