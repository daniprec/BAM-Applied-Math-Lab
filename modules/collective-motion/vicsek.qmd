...
![](../../img/s04_order_parameter_vs_noise.png){fig-alt="Order parameter vs noise" fig-cap="Order parameter vs noise" width=400px}
...
![](../../img/s04_avg_velocity_vs_density.png){fig-alt="Average velocity vs density" fig-cap="Average velocity vs density" width=400px}
