---
title: "Vicsek Model"
subtitle: "Full Interactive Animation"
format: html
---
...
- a noise diagnostic plot,
- and sliders to explore the parameter space.
...
- [x] call `vicsek_equations(...)`
- [x] update `xy_tail` with `np.roll(...)`
- [x] `plt_particles.set_data(...)` and `plt_current.set_data(...)`
