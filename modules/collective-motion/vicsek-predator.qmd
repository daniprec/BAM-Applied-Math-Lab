...
::: {.callout-warning}
**Warning:** This section will *not* be covered this year. You are welcome to explore or implement the idea, but the code and example may be outdated.
:::
...
$$\Theta_{\text{rep}, i} = \tan^{-1}\left(\frac{y_i - y_{\text{pred}}}{x_i - x_{\text{pred}}}\right).$$ {#eq-collective-motion-vicsek-predator-1}

We blend alignment and repulsion with strength $k$:

$$\Theta_i = (1-k)\left(\langle \Theta_j \rangle + \eta_i\right) + k\,\Theta_{\text{rep}, i}.$$ {#eq-collective-motion-vicsek-predator-2}
...
If you want a full working reference, check [amlab/collective_motion/vicsek_predator.py](../../amlab/collective_motion/vicsek_predator.py).
