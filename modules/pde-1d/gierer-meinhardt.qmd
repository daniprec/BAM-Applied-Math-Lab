...
from code.pdes_1d.gierer_meinhardt_1d import gierer_meinhardt_pde
...
::: {.callout-tip}
Full reference code is available in [code/pdes_1d](https://github.com/daniprec/BAM-Applied-Math-Lab/blob/main/code/pdes_1d/gierer_meinhardt_1d.py).
:::
