...
$$u_x(0)=0,\quad u(0)=u(h)$$ {#eq-pde-1d-gierer-meinhardt-4}

### Dirichlet (fixed values)

$$u(0)=\alpha,\quad u(L)=\beta$$ {#eq-pde-1d-gierer-meinhardt-5}

### Periodic

$$u(0)=u(L)$$ {#eq-pde-1d-gierer-meinhardt-6}

## Exercise: Simulate the PDE

We will use $L=40$, $dx=0.5$, $dt=0.001$, $a=0.40$, $b=1.00$, $d=20$, and $\gamma=1$. Follow the steps below and compare your result with @fig-gm-1d.
...
::: {.callout-tip}
Full reference code is available in [amlab/pdes_1d](https://github.com/daniprec/BAM-Applied-Math-Lab/blob/main/amlab/pdes_1d/gierer_meinhardt_1d.py).
:::
