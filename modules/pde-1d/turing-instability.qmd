...
Turing instability explains when a uniform steady state becomes unstable **to spatial perturbations**, leading to patterns. We analyze it for the Gierer-Meinhardt system by checking conditions on the Jacobian and diffusion ratio.
...
from sessions.s03_pdes_1d.gierer_meinhardt_1d import is_turing_instability
...
## Exercise: Implement a Turing test
...
::: {.callout-tip}
You can find a complete interactive implementation in [sessions/s03_pdes_1d](../../sessions/s03_pdes_1d/).
:::
